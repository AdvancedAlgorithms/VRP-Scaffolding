...
Spring 2020 at Olin College. Adapted for Advanced Algorithms Spring 
2021. These functions run tests on student solutions to the integer 
programming implementation of the vehicle routing problem.'''
