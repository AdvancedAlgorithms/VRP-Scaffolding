...
Spring 2021 at Olin College. These functions read data files for the vehicle
routing problem that use the VRP-REP file format. This code has been adapted
from code for the VRP from the Advanced Algorithms course in Spring 2020,
which in turn was adapted from functions written by Alice Paul.'''
